...
- `TICK_<ms>`: Ejecutados periódicamente en etapas temporales, permitiendo patrones hápticos sincronizados; `ms` indica
  un
  valor en milisegundos (ej.: `TICK_1000`, `TICK_2500`, etc.).
...
- **Base de Datos**: una instancia de **MongoDB** configurada. El sistema utiliza colecciones para el almacenamiento de
  experimentos, sujetos, dispositivos y los resultados de los ensayos. La conexión se define mediante una URI en el
