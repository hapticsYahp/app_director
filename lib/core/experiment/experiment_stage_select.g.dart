...
Map<String, dynamic> _$ExperimentStageSelectToJson<T_Result>(
  ...
  Object? Function(T_Result value) toJsonT_Result,
    ...
    <String, dynamic>{
      ...
      'confirmButtonIcon':
          const IconDataJsonConverter().toJson(instance.confirmButtonIcon),
      'clearButtonLabel': instance.clearButtonLabel,
      'clearButtonIcon':
          const IconDataJsonConverter().toJson(instance.clearButtonIcon),
    };
