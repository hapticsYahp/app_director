...
ExperimentStageFeedback<T_Result> _$ExperimentStageFeedbackFromJson<T_Result>(
  ...
  initialSelectedValue: (json['initialSelectedValue'] as num?)?.toInt() ?? 5,
  positiveLabel: json['positiveLabel'] as String? ?? "Yes",
  negativeLabel: json['negativeLabel'] as String? ?? "No",
  feedbackLabel:
      json['feedbackLabel'] as String? ?? "Indicate the perceived intensity:",
  ...
  positiveIcon: json['positiveIcon'] == null
      ...
      : const IconDataJsonConverter().fromJson(
          (json['positiveIcon'] as num).toInt(),
        ),
  negativeIcon: json['negativeIcon'] == null
      ? Icons.thumb_down
      : const IconDataJsonConverter().fromJson(
          (json['negativeIcon'] as num).toInt(),
        ),
  confirmIcon: json['confirmIcon'] == null
      ? Icons.check
      : const IconDataJsonConverter().fromJson(
          (json['confirmIcon'] as num).toInt(),
        ),
  pomaCommands:
...
Map<String, dynamic> _$ExperimentStageFeedbackToJson<T_Result>(
  ...
  'positiveIcon': const IconDataJsonConverter().toJson(instance.positiveIcon),
  'negativeIcon': const IconDataJsonConverter().toJson(instance.negativeIcon),
