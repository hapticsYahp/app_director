...
#### Confirmar
El comportamiento de esta Etapa es presentar al usuario un botón.
La Etapa lanza un resultado fijo (y por lo tanto finaliza) cuando el usuario presiona el botón.
